    ...
    .then(data => {
        g.selectAll("path")
            ...
            .attr("class", d => {
                ...
                if (["NOR", "BRA", "COL", "GUY", "MEX", "JPN", "BEL", "PRT", "GBR", "AUS", "ARG", "CHL", "PER", "PAN", "CRI", "GTM", "DOM", "USA", "ECU", "PRY", "URY", "SLV", "FRA", "DEU", "ITA", "ESP", "GRC", "TUR", "CAN"].includes(d.id)) return "country blue";
                if (["BOL", "CUB", "NIC", "HND", "RUS", "BLR", "CHN", "IRN", "SRB", "SYR"].includes(d.id)) return "country red";
                return "country grey";
            })
            .attr("d", path)
