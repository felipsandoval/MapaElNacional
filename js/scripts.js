    ...
    .then(data => {
        g.selectAll("path")
            ...
            .attr("class", d => {
                ...
                if (["NLD", "POL", "NOR", "BRA", "COL", "GUY", "MEX", "JPN", "BEL", "PRT", "GBR", "AUS", "ARG", "CHL", "PER", "PAN", "CRI", "GTM", "DOM", "USA", "ECU", "PRY", "URY", "SLV", "FRA", "DEU", "ITA", "ESP", "GRC", "CAN"].includes(d.id)) return "country blue";
